...
def Intro():
    print("*"*210)
    print()
    print("Database Management System".center(210))
    print("Project".center(210))
    print("18CSC303J".center(210))
    print()
    print("*"*210)
    print()
    print("Bank Management System".center(210))
    print()
    print("*"*210)
    print()
    print("By".center(210))
    print("Rishav Kumar Jha".center(210))
    print("Ravi Patel".center(210))
    print()
    print("*"*210)
...
def main():
    ...
    print("\nUSER: root@localhost", end='')
    print(str_time.rjust(185," "))
    print("Hello user root@localhost")
